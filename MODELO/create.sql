...
ALTER TABLE HILOS ADD CONSTRAINT PETICIONES_HILOS 
...
ALTER TABLE CLIENTES ADD CONSTRAINT GRUPOS_CLIENTES 
    FOREIGN KEY (GRUPO) REFERENCES GRUPOS (ID_GRUPO);

ALTER TABLE CLIENTES ADD CONSTRAINT DEPARTAMENTOS_CLIENTES 
    FOREIGN KEY (DTO) REFERENCES DEPARTAMENTOS (ID_DTO);

ALTER TABLE ALMACENCERT ADD CONSTRAINT CLIENTES_ALMACENCERT 
    FOREIGN KEY (ID) REFERENCES CLIENTES (ALMACENCERT);
...
ALTER TABLE GREMIOS ADD CONSTRAINT USUARIOS_GREMIOS 
    FOREIGN KEY (ID) REFERENCES USUARIOS (IDGREMIO);

ALTER TABLE INVITADOS ADD CONSTRAINT CLIENTES_INVITADOS 
    FOREIGN KEY (IDCLIENTE) REFERENCES CLIENTES (ID);

ALTER TABLE DEPARTAMENTOS ADD CONSTRAINT GRUPOS_DTOS_DEPARTAMENTOS 
    FOREIGN KEY (ID_DTO) REFERENCES GRUPOS_DTOS (ID_DTO);

ALTER TABLE GRUPOS ADD CONSTRAINT GRUPOS_DTOS_GRUPOS 
    FOREIGN KEY (ID_GRUPO) REFERENCES GRUPOS_DTOS (ID_GRUPO);

ALTER TABLE WORKFORCE ADD CONSTRAINT CONSUMOS_WORKFORCE 
    FOREIGN KEY (ID) REFERENCES CONSUMOS (WORKFORCE);

ALTER TABLE CALENDARIO_DOCS ADD CONSTRAINT TIPOS_DOC_CALENDARIO_DOCS 
    FOREIGN KEY (IDTIPODOC) REFERENCES TIPOS_DOC (ID);

ALTER TABLE WEB_PERSONAL ADD CONSTRAINT CLIENTES_WEB_PERSONAL 
    FOREIGN KEY (IDCLIENTE) REFERENCES CLIENTES (ID);

ALTER TABLE TABLON ADD CONSTRAINT WEB_PERSONAL_TABLON 
    FOREIGN KEY (IDCLIENTE) REFERENCES WEB_PERSONAL (IDCLIENTE);
...
CREATE TRIGGER Trg_WEB_PERSONAL1
BEFORE INSERT ON WEB_PERSONAL FOR EACH ROW
BEGIN
  SELECT S_WEB_PERSONAL.NEXTVAL
  INTO :NEW.ID
  FROM DUAL;
END;
/
